...
- **DARK is the chosen version** (Darren, 2026-09-08). `index.html` is the sole public page. Theme cross-links removed from all footers.
- `index-light.html` / `styles-light.css` and `index-edgy.html` / `styles-edgy.css` are KEPT as reference/alternate designs (both still noindex) in case we revisit. Not linked from the live site.
